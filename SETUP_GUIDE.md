...
Öffne Terminal/Command Prompt im Projekt-Ordner:
...
git remote add origin https://github.com/DEIN-USERNAME/nu-personality-app.git
...
```
https://DEIN-USERNAME.github.io/nu-personality-app
```
...
```json
{
  ...
  "homepage": "https://DEIN-USERNAME.github.io/nu-personality-app",
  ...
}
```
